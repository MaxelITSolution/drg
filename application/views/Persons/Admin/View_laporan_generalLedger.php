...
<ul class="nav nav-pills nav-justified">
	...
	<ul class="dropdown-menu">
		<li class="<?php echo $active1;?>"><a href="#menu1" data-toggle="pill">Laba Rugi</a></li>
		<li class="<?php echo $active2;?>"><a href="#menu2" data-toggle="pill">Neraca Saldo</a></li>
		<li class="<?php echo $active3;?>"><a href="#menu3" data-toggle="pill">Buku Besar</a></li>
		<li class="<?php echo $active4;?>"><a href="#menu4" data-toggle="pill">Jurnal Penyesuaian</a></li>
	</ul>
	</li>
</ul>
