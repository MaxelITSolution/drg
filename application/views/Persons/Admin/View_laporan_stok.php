...
<ul class="nav nav-pills nav-justified">
	...
	<ul class="dropdown-menu"> 
		...
		<li class="<?php echo $active3;?>"><a href="#menu2" data-toggle="pill" >Pindah Lokasi</a></li>
		<li class="<?php echo $active4;?>"><a href="#menu2" data-toggle="pill" >Penyesuaian</a></li>
		<li class="<?php echo $active5;?>"><a href="#menu2" data-toggle="pill">Stok Habis</a></li>
	</ul>
	...
	<div class="container-fluid">
		<div class="tab-content">
			...
			<div id="menu5" class="tab-pane fade in <?php echo $active5;?>">
				<h3>Stok Habis</h3>
			</div>
		</div>
	</div>
